...
@Component({
  ...
  host: { '[class.animated]': 'animated()', '[class.dragon]': 'species() === "dragon"', '[class.sleeping]': 'sleeping()', '[class.dog]': 'species() === "dog"', '[class.parrot]': 'species() === "parrot"', '[class.dinosaur]': 'species() === "dinosaur"' }
})
